      ...
      <div className="dizme_tm_all_wrap overflow-hidden" data-magic-cursor="show">
        <div className="dizme_tm_intro">
          ...
          <div className="short_info">
            <h3 style={{marginTop:"-40px"}} className="">Hey there!! Select Your Prefered Theme</h3>
          </div>
            ...
            <div className="left">
              ...
              <h3 className="titlesss">Light Theme</h3>
                <a  href="index-white" target="_blank" >
                  <img data-aos="slide-left" className="img1" src="img/intro/light.png" alt="image" />
                </a>
            ...
            <div className="right">
              <div  className="desc"> 
                <a href="index-dark" target="_blank" >
                  <img  data-aos="slide-right" className="img2" src="img/intro/dark.png" alt="image" />
                </a>
